...
export class MoviesService {
  ...
  private movies: Array<any> = [
    ...
    },
    {
      ...
      description: "Płatni mordercy, Jules (Samuel L. Jackson) i Vincent (John Travolta), dostają zlecenie, by odzyskać z rąk przypadkowych rabusiów tajemniczą walizkę bossa mafii. Nie dość tego, Vincent dostaje kolejną robotę - na czas nieobecności gangstera w mieście ma zaopiekować się jego poszukującą wrażeń żoną Mią (Uma Thurman). Vincent i Jules niespodziewanie wpadają po uszy, gdy przypadkowo zabijają zakładnika. Kłopoty ma też podupadły bokser (Bruce Willis), który otrzymał dużą sumę za przegranie swojej walki. Walkę jednak wygrywa, a Los Angeles staje się od tej chwili dla niego za małe. Specjaliści od mokrej roboty będą mieli co robić... (źródło: Filmweb)",
    ...
    },
    {
      ...
      description: "Mary jest ośmioletnią dziewczynką mieszkającą w Australii. Przez swoje kompleksy nie ma przyjaciół. Pewnego dnia postanawia napisać list do kogoś kto mieszka w Ameryce. Wybór pada na Maxa, mieszkańca Nowego Jorku. Max z kolei jest 40-letnim samotnikiem mieszkającym przy Manhattanie. Dzięki korespondencyjnej znajomości jaka zostaje nawiązana rodzi się przyjaźń, która pomimo odległości jest w stanie przetrwać wiele wzlotów i upadków zarówno Maxa jak i Mary. (źródło: Filmweb)",
